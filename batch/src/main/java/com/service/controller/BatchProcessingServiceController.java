...
public class BatchProcessingServiceController {
    ...
    private static final String bucketBindingName = "bucketstore";
    ...
    public ResponseEntity<String> processBatch() throws Exception {
        ...
        try (DaprClient client = new DaprClientBuilder().build()) {
            ...
            for (Order order : ordList.orders) {
                ...
                //client.invokeBinding(bucketBindingName, "create", orderText, metadata).block();
                client.invokeBinding(bucketBindingName, "create", orderText.getBytes(), metadata).block();
            } 
